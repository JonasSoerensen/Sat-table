...
/* package Sat-table-0.1.0.0 */
#ifndef VERSION_Sat_table
#define VERSION_Sat_table "0.1.0.0"
#endif /* VERSION_Sat_table */
#ifndef MIN_VERSION_Sat_table
#define MIN_VERSION_Sat_table(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Sat_table */
...
/* package table-layout-1.0.0.0 */
#ifndef VERSION_table_layout
#define VERSION_table_layout "1.0.0.0"
...
#define CURRENT_COMPONENT_ID "Sat-table-0.1.0.0-inplace-Sat-table"
